import { Alert, AlertIcon, Button, FormControl, FormLabel, HStack, Input, Radio, RadioGroup, Select, Textarea, Toast, useToast } from "@chakra-ui/react"
    ...
    return (
        <div>
            <Container>
                ...
                <FormControl>
                    <Button onClick={handleSubmit} isLoading={addLoading} loadingText='جاري الإضافة' className="my-7 w-full" colorScheme='teal'>إضافة المدينة</Button>
                </FormControl>
            </Container>
        </div>
    )
